...
import logo from "../img/Group2.png";
  ...
  return (
    <header className="header center">
      <div className="header__left">
        ...
        <Link to="#" className="header__left-search">
          <svg
            width="26"
            height="27"
            viewBox="0 0 26 27"
      ...
      <nav className="header__right">
        <div className="header__right-menu">
          ...
          <nav className="header__nav">
            <div className="header__nav-content">
              <h3 className="header__nav-head">MENU</h3>
              <details className="header__nav-item">
                <summary className="header__nav-heading">MAN</summary>
                <div className="header__nav-link-box">
              ...
              <details className="header__nav-item">
                <summary className="header__nav-heading">WOMAN</summary>
                <div className="header__nav-link-box">
                  <Link to="" className="header__nav-link">
                    Accessories
                  </Link>
              ...
              <details className="header__nav-item">
                <summary className="header__nav-heading">KIDS</summary>
                <div className="header__nav-link-box">
                  <Link to="" className="header__nav-link">
                    Accessories
                  </Link>
        ...
        <Link
          to="/registration"
          className="header__right-link header__right-link_mobile"
        >
          <svg
            width="29"
            height="29"
